...
schema_json =  'TIKA\02. Data Engineer\Week 5\Project 3\sql\schemas'
create_schema_sql = """create table user_address_2018_snapshots {};"""
zip_small_file = 'TIKA\02. Data Engineer\Week 5\Project 3\temp'\dataset-small.zip'
result_ingestion_check_sql = 'TIKA\02. Data Engineer\Week 5\Project 3\sql\queries'\result_ingestion_user_address.sql'
